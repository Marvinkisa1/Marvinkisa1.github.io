...
UNWANTED_EXTENSIONS = ['.mkv','.mp4','.avi','.mov','.flv','.wmv','.mp3','.aac','.wav','.m4a']

ADULT_KEYWORDS = ['adult','18+','xxx','porn','sex','erotic','hentai','blowjob','fuck','cum','milf']

FAKE_HINTS = ['mycamtv', 'mysuperhot.com', 'qr code', 'scan to watch', 'static image', 'pay to watch']

SCRAPER_HEADERS = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'}
KENYA_HEADERS = SCRAPER_HEADERS